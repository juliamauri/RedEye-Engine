...
unsigned int RE_ModelSettings::GetFlags() const
{
	...
	if (fromPreset) {
		...
		{
		case 0:
			ret = aiProcessPreset_TargetRealtime_Fast;
			break;
		case 1:
			ret = aiProcessPreset_TargetRealtime_MaxQuality;
			break;
		case 2:
			ret = aiProcessPreset_TargetRealtime_Quality;
			break;
		}
	}
	else
	{
		...
		while (!toAdd.empty()) {
			...
			{
			case 0:
				ret |= aiProcess_CalcTangentSpace;
				break;
			case 1:
				ret |= aiProcess_JoinIdenticalVertices;
				break;
			case 2:
				ret |= aiProcess_Triangulate;
				break;
			case 3:
				ret |= aiProcess_RemoveComponent;
				break;
			case 4:
				ret |= aiProcess_GenNormals;
				break;
			case 5:
				ret |= aiProcess_GenSmoothNormals;
				break;
			case 6:
				ret |= aiProcess_SplitLargeMeshes;
				break;
			case 7:
				ret |= aiProcess_PreTransformVertices;
				break;
			case 8:
				ret |= aiProcess_LimitBoneWeights;
				break;
			case 9:
				ret |= aiProcess_ValidateDataStructure;
				break;
			case 10:
				ret |= aiProcess_ImproveCacheLocality;
				break;
			case 11:
				ret |= aiProcess_RemoveRedundantMaterials;
				break;
			case 12:
				ret |= aiProcess_FixInfacingNormals;
				break;
			case 13:
				ret |= aiProcess_SortByPType;
				break;
			case 14:
				ret |= aiProcess_FindDegenerates;
				break;
			case 15:
				ret |= aiProcess_FindInvalidData;
				break;
			case 16:
				ret |= aiProcess_GenUVCoords;
				break;
			case 17:
				ret |= aiProcess_TransformUVCoords;
				break;
			case 18:
				ret |= aiProcess_FindInstances;
				break;
			case 19:
				ret |= aiProcess_OptimizeMeshes;
				break;
			case 20:
				ret |= aiProcess_OptimizeGraph;
				break;
			case 21:
				ret |= aiProcess_FlipUVs;
				break;
			case 22:
				ret |= aiProcess_FlipWindingOrder;
				break;
			case 23:
				ret |= aiProcess_SplitByBoneCount;
				break;
			case 24:
				ret |= aiProcess_Debone;
				break;
			}
		}
	}
