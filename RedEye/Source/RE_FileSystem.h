...
public:
	...
	enum FileType { F_NOTSUPPORTED = -1, F_NONE, F_MODEL, F_TEXTURE, F_MATERIAL, F_SKYBOX, F_PREFAB, F_SCENE, F_PARTICLEEMITTER, F_PARTICLEEMISSOR, F_PARTICLERENDER, F_META };
