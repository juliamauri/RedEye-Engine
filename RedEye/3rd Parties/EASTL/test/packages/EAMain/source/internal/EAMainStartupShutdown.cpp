...
namespace EA
{
    namespace EAMain
    {
        namespace Internal
        {
                ...
                {
                    EA::EAMain::Report(reinterpret_cast<const char8_t*>("\n"));
                    EA::EAMain::Report(reinterpret_cast<const char8_t*>("===============================================================================\n"));
                    EA::EAMain::Report(reinterpret_cast<const char8_t*>("ATTENTION ATTENTION ATTENTION ATTENTION ATTENTION ATTENTION ATTENTION ATTENTION\n"));
                    EA::EAMain::Report(reinterpret_cast<const char8_t*>("An unhandled exception has been detected. This likely means the application is \n"));
                    EA::EAMain::Report(reinterpret_cast<const char8_t*>("crashing.\n\n"));
                    EA::EAMain::Report(reinterpret_cast<const char8_t*>("(This message is courtesy of EAMain but does not mean that EAMain is\n"));
                    EA::EAMain::Report(reinterpret_cast<const char8_t*>("the cause of the crash.)\n"));
                    EA::EAMain::Report(reinterpret_cast<const char8_t*>("===============================================================================\n"));
