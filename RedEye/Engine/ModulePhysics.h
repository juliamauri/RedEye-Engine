...
public:
	...
	void DrawParticleEmitterSimulation(
		uint index,
		math::float3  go_positon = math::float3::zero,
		math::float3 go_up = math::float3::unitY) const;
	...
	void DrawDebug(const RE_Camera& camera) const;
	void DrawEditor();
