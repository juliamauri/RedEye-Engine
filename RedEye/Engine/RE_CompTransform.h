...
public:
	...
	void OnTransformModified() final { needed_update_transform = true; }
	...
	// Getters
	math::Quat GetLocalQuaternionRotation() const { return rot_quat; }
	math::vec GetLocalEulerRotation() const { return rot_eul; }
	math::vec GetLocalScale() const { return scale.scale; }
	math::vec GetLocalPosition() const { return pos; }
