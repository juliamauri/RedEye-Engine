...
# ── C++23‑modules linkage fix (no external patch file) ────────────────
vcpkg_replace_string("${SOURCE_PATH}/include/rapidjson/pointer.h"
        "static const SizeType kPointerInvalidIndex"
        "inline constexpr SizeType kPointerInvalidIndex")
vcpkg_replace_string("${SOURCE_PATH}/include/rapidjson/pointer.h"
        "inline const Token kPointerInvalidToken"
        "inline constexpr Token kPointerInvalidToken")
vcpkg_replace_string("${SOURCE_PATH}/include/rapidjson/document.h"
        "static const SizeType kDefaultStackCapacity"
        "inline constexpr SizeType kDefaultStackCapacity")
vcpkg_replace_string("${SOURCE_PATH}/include/rapidjson/document.h"
        "static const ParseErrorCode kDefaultParseErrorCode"
        "inline constexpr ParseErrorCode kDefaultParseErrorCode")
