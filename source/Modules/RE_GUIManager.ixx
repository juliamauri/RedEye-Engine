...
export namespace RE
{
    ...
    {
        /**
         * @brief Initializes the ImGui context and sets up the SDL and OpenGL
         * backends.
         ...
         * @param DrawContent The function to draw the content of the main
         * window.
         */
        ...
        /**
         * @brief Cleans up the ImGui context and shuts down the SDL and OpenGL
         * backends.
         */
        void CleanUp()
        {
